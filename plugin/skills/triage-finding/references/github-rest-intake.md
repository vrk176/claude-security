...
Use this reference when `the `triage-finding` skill` is invoked with a GitHub repository instead of pasted finding data.
...
1. The current repository's GitHub remote.
